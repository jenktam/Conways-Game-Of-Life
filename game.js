...
const gameOfLife = {
  ...
  getNeighbors: function(cell){
    const neighbors = [];
    const thisCellCoords = this.getCoordsOfCell(cell);
    const cellX = thisCellCoords[0];
    const cellY = thisCellCoords[1];
  ...
  step: function () {
    ...
    this.forEachCell(function(cell, x, y){
      const countLiveNeighbors = gameOfLifeObj.getAliveNeighbors(cell).length;
